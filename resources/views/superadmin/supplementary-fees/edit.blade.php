{{-- resources/views/superadmin/supplementary-fees/edit.blade.php --}}
            ...
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        Edit Supplementary Fee - {{ $programme->name }}
                    </h3>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" 
                          action="{{ route('superadmin.programmes.supplementary-fees.update', [$programme->id, $fee->id]) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-warning">
                                <i class="fas fa-save"></i> Update Supplementary Fee
                            </button>
                            <a href="{{ route('superadmin.programmes.supplementary-fees.index', $programme->id) }}" 
