{{-- resources/views/superadmin/supplementary-fees/create.blade.php --}}
            ...
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        Add Supplementary Fee - {{ $programme->name }}
                    </h3>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" 
                          action="{{ route('superadmin.programmes.supplementary-fees.store', $programme->id) }}">
                        @csrf
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-warning">
                                <i class="fas fa-save"></i> Save Supplementary Fee
                            </button>
                            <a href="{{ route('superadmin.programmes.supplementary-fees.index', $programme->id) }}" 
