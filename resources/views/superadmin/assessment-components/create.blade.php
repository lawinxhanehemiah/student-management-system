...
@section('title', 'Create Assessment Component')
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Add New Assessment Component</h3>
                </div>
                <form action="{{ route('superadmin.assessment-components.store') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="module_id" id="module_id" class="form-control @error('module_id') is-invalid @enderror" required>
                                ...
                                <option value="{{ $module->id }}" {{ old('module_id') == $module->id ? 'selected' : '' }}>{{ $module->code }} - {{ $module->name }}</option>
                                @endforeach
                            </select>
