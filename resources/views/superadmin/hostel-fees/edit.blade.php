{{-- resources/views/superadmin/hostel-fees/edit.blade.php --}}
            ...
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        Edit Hostel Accommodation Fee - {{ $programme->name }}
                    </h3>
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        <br>Hii ni ada ya <strong>JUMLA</strong> kwa muhula.
                    </div>

                    <form method="POST" 
                          action="{{ route('superadmin.programmes.hostel-fees.update', [$programme->id, $fee->id]) }}">
                        @csrf
                        @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="semester" class="form-control @error('semester') is-invalid @enderror" required>
                                        ...
                                        @foreach($semesters as $key => $semester)
                                            <option value="{{ $key }}" {{ old('semester', $fee->semester) == $key ? 'selected' : '' }}>
                                                {{ $semester }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" 
                                               ...
                                               value="{{ old('total_fee', $fee->total_fee) }}"
                                               step="1000"
                                               min="0"
                                               required>
                                    </div>
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-save"></i> Update Hostel Fee
                            </button>
                            <a href="{{ route('superadmin.programmes.hostel-fees.index', $programme->id) }}" 
