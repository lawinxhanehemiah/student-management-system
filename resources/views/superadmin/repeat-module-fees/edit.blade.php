{{-- resources/views/superadmin/repeat-module-fees/edit.blade.php --}}
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        Edit Repeat Module Fee - {{ $programme->name }}
                    </h3>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" 
                          action="{{ route('superadmin.programmes.repeat-module-fees.update', [$programme->id, $fee->id]) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-info">
                                <i class="fas fa-save"></i> Update Repeat Module Fee
                            </button>
                            <a href="{{ route('superadmin.programmes.repeat-module-fees.index', $programme->id) }}" 
