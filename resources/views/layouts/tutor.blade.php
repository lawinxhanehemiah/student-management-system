...
<body>
  ...
  <nav class="nxl-navigation">
    <div class="m-header py-3">
        <a href="{{ route('tutor.dashboard') }}" class="b-brand d-flex align-items-center justify-content-center">
            <img src="{{ asset('assets/images/logo.webp') }}" alt="Logo" class="logo logo-lg img-fluid" />
            <span class="brand-name fw-bold text-dark ms-2">TUTOR Panel</span>
        </a>
    </div>
    ...
    <div class="navbar-content">
        <ul class="nxl-navbar">
            ...
            <li class="nxl-item tutor-menu-item {{ request()->routeIs('tutor.dashboard') ? 'active' : '' }}">
                <a href="{{ route('tutor.dashboard') }}" class="nxl-link">
            ...
            <li class="nxl-item nxl-hasmenu tutor-menu-item {{ request()->is('tutor/modules*') ? 'active' : '' }}">
                <a href="javascript:void(0);" class="nxl-link">
                    <span class="nxl-micon"><i class="feather-book-open"></i></span>
                    <span class="nxl-mtext">My Modules</span>
                    <span class="nxl-arrow"><i class="feather-chevron-right"></i></span>
                </a>
                <ul class="nxl-submenu">
                    <li class="nxl-item"><a class="nxl-link" href="{{ route('tutor.courses.index') }}">Assigned Modules</a></li>
                    <li class="nxl-item"><a class="nxl-link" href="{{ route('tutor.materials.index') }}">Learning Materials</a></li>
                </ul>
            </li>

            <li class="nxl-item nxl-hasmenu tutor-menu-item {{ request()->routeIs('tutor.students.*') ? 'active' : '' }}">
                <a href="javascript:void(0);" class="nxl-link">
                ...
                <ul class="nxl-submenu">
                    <li class="nxl-item"><a class="nxl-link" href="{{ route('tutor.students.index') }}">Student List</a></li>
                    <li class="nxl-item"><a class="nxl-link" href="{{ route('tutor.attendance.index') }}">Attendance Tracking</a></li>
                </ul>
            </li>
            ...
            <li class="nxl-item nxl-hasmenu tutor-menu-item {{ request()->is('tutor/results*') ? 'active' : '' }}">
    <a href="javascript:void(0);" class="nxl-link">
    ...
    <ul class="nxl-submenu">
        <li class="nxl-item">
            <a class="nxl-link" href="{{ route('tutor.results.index') }}">
                Course Work (CA) <span class="badge bg-soft-info text-info ms-auto">Tests</span>
            </a>
        </li>
        <li class="nxl-item">
            <a class="nxl-link" href="{{ route('tutor.results.index') }}">
        ...
        <li class="nxl-item">
            <a class="nxl-link" href="{{ route('tutor.results.consolidated') }}">
                Consolidated Marks
            </a>
        </li>
        <li class="nxl-item">
            <a class="nxl-link" href="{{ route('tutor.results.approval-status') }}">
                Approval Status 
                <span class="badge bg-soft-warning text-warning ms-1" style="font-size: 10px;">Workflow</span>
            </a>
        </li>
        <li class="nxl-item">
            <a class="nxl-link" href="{{ route('tutor.results.ministry-import.form') }}">
                Ministry Results (S2)
            </a>
        </li>
    </ul>
            ...
            <li class="nxl-item nxl-hasmenu tutor-menu-item">
                <a href="javascript:void(0);" class="nxl-link">
                ...
                <ul class="nxl-submenu">
                    <li class="nxl-item"><a class="nxl-link" href="">Module Performance</a></li>
                    <li class="nxl-item"><a class="nxl-link" href="">GPA Trends</a></li>
                </ul>
            </li>
            ...
            <li class="nxl-item tutor-menu-item">
                <a href="{{ route('tutor.announcements.index') }}" class="nxl-link">
        ...
        <div class="m-3 p-3 bg-soft-primary rounded">
            <div class="d-flex align-items-center">
                ...
                <span class="fw-medium text-dark">Portal Support</span>
            </div>
            <p class="small text-muted mt-2 mb-0">Unahitaji msaada wa mfumo? Wasiliana na IT Department.</p>
        </div>
    </div>
</nav>
    <!--! ================================================================ !-->
