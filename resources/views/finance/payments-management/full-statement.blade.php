                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        ...
                        <div class="d-flex justify-content-center gap-2 flex-wrap">
                            <a href="{{ route('finance.student-payment-info.show', 11) }}" class="btn btn-sm btn-outline-primary">
                                Student 11
                            </a>
                            <a href="{{ route('finance.student-payment-info.show', 12) }}" class="btn btn-sm btn-outline-primary">
                                Student 12
                            </a>
                            <a href="{{ route('finance.student-payment-info.show', 13) }}" class="btn btn-sm btn-outline-primary">
                                Student 13
                            </a>
