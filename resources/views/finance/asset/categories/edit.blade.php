    ...
    <div class="page-title">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('finance.asset.categories.show', $category->id) }}">{{ $category->name }}</a></li>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('finance.asset.categories.update', $category->id) }}" method="POST">
            @csrf
            @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('depreciation_method') is-invalid @enderror" 
                                    ...
                                    <option value="none" {{ old('depreciation_method', $category->depreciation_method) == 'none' ? 'selected' : '' }}>
                                        No Depreciation
                                    </option>
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('default_useful_life_years') is-invalid @enderror" 
                                       ...
                                       value="{{ old('default_useful_life_years', $category->default_useful_life_years) }}" min="1">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control @error('default_salvage_value_percentage') is-invalid @enderror" 
                                           ...
                                           value="{{ old('default_salvage_value_percentage', $category->default_salvage_value_percentage) }}" 
                    ...
                    <div class="info-card">
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <p><strong>Assets:</strong> {{ $category->assets_count ?? 0 }}</p>
            ...
            <div class="form-actions mt-4">
                ...
                <a href="{{ route('finance.asset.categories.show', $category->id) }}" class="btn btn-secondary">
