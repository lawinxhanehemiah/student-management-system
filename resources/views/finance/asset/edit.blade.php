    ...
    <div class="page-title">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('finance.asset.assets.show', $asset->id) }}">{{ $asset->asset_tag }}</a></li>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('finance.asset.assets.update', $asset->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-lg-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('purchase_cost') is-invalid @enderror" 
                                           id="purchase_cost" name="purchase_cost" value="{{ old('purchase_cost', $asset->purchase_cost) }}" required>
                                </div>
                                @error('purchase_cost')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control @error('useful_life_years') is-invalid @enderror" 
                                       ...
                                       value="{{ old('useful_life_years', $asset->useful_life_years) }}" min="1" required>
                    ...
                    <div class="form-section mt-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="status" class="form-label required">Asset Status</label>
                                <select class="form-select @error('status') is-invalid @enderror" 
                                    ...
                                    <option value="transferred" {{ old('status', $asset->status) == 'transferred' ? 'selected' : '' }}>Transferred</option>
                    ...
                    <div class="info-card">
                        <div class="card bg-light">
                            <div class="card-body">
                                ...
                                <p><strong>Current Value:</strong> {{ number_format($asset->current_value, 2) }}</p>
                                <p><strong>Age:</strong> {{ $asset->getAgeInYears() }} years</p>
                                <p><strong>Remaining Life:</strong> {{ $asset->getRemainingLifeYears() }} years</p>
                                <p><strong>Depreciation:</strong> {{ $asset->getDepreciationPercentage() }}%</p>
                                <p><strong>Created:</strong> {{ $asset->created_at->format('d M Y') }}</p>
                                <hr>
                                <p class="small text-muted mb-0">
                                    <i class="fas fa-exclamation-triangle me-2"></i>
                                    Changing purchase cost affects depreciation
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-actions mt-4">
                ...
                <a href="{{ route('finance.asset.assets.show', $asset->id) }}" class="btn btn-secondary">
