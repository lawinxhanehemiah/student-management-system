{{-- resources/views/hod/promotion/semester.blade.php --}}
@extends('layouts.hod')

@section('title', 'Promote by Semester')
...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="fw-bold mb-0">Promote by Semester</h4>
            <p class="text-muted mb-0">Review and promote students to next semester</p>
        </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('hod.promotion.semester') }}" id="filterForm">
                <div class="row g-3">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        ...
                        @if(!empty($filters['search']) || !empty($filters['level']) || !empty($filters['semester']) || !empty($filters['eligibility_status']))
                            <a href="{{ route('hod.promotion.semester') }}" class="btn btn-outline-danger btn-sm ms-2">
    ...
    <div class="card">
                    ...
                    <thead class="table-light">
                        ...
                        <tbody>
                            ...
                            @php
                                ...
                                $gpaClass = $gpa >= 2.0 ? 'success' : ($gpa >= 1.5 ? 'warning' : 'danger');
                                $gpaText = $gpa >= 2.0 ? 'Good' : ($gpa >= 1.5 ? 'Pass' : 'Probation');
                            @endphp
        ...
        <form id="promotionForm" action="{{ route('hod.promotion.process-semester') }}" method="POST" style="display: none;">
            @csrf
    ...
    $(document).ready(function() {
        ...
        $('#promoteBtn').click(function() {
            ...
            Swal.fire({
                ...
                html: `<p>Are you sure you want to promote <strong>${count}</strong> student(s) to next semester?</p>
